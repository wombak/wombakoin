  ...
  namespace Base58
  {
    namespace
    {
      ...
      uint64_t uint_8be_to_64(const uint8_t* data, size_t size)
      {
        ...
        {
        case 1:            res = res | *data++;
        case 2: res <<= 8; res = res | *(data++);
        case 3: res <<= 8; res = res | *data++;
        case 4: res <<= 8; res = res | *data++;
        case 5: res <<= 8; res = res | *data++;
        case 6: res <<= 8; res = res | *data++;
        case 7: res <<= 8; res = res | *data++;
        case 8: res <<= 8; res = res | *data; break;
